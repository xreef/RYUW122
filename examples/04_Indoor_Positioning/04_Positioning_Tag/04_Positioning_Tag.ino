...
/**
 * @file 04_Positioning_Tag.ino
 * @brief TAG sketch for the Indoor Positioning example.
 * @version 1.0.0
 * @date 2025-10-10
 *
...
const char* NETWORK_ID = "REYAXPOS"; // Must match the network ID of the anchors
const char* TAG_ADDRESS = "TAG_POS1"; // The address the Master Anchor is looking for
...
void setup() {
    ...
    Serial.println(F("\n================================================"));
    Serial.println(F("  RYUW122 Indoor Positioning - TAG"));
    Serial.println(F("================================================"));
